...
import com.licrafter.album.R;

import java.util.ArrayList;
import java.util.List;

import boxing_impl.WindowManagerHelper;
import boxing_impl.adapter.BoxingAlbumAdapter;
import boxing_impl.adapter.BoxingMediaAdapter;
import boxing_impl.view.MediaItemLayout;
import boxing_impl.view.SpacesItemDecoration;
